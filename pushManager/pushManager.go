...
func (p *PushManager) PushToAll(device_type, msg_type, title, msg, deploy_status string, parameters map[string]interface{}) (resp map[string]interface{}, err error) {
	...
	dic["msg"] = util.BuildMessage(title, msg, parameters, device_type)
	p.applyBaseParameters(dic)
	dic["sign"] = util.GenerateSignature("POST", targetURL, p.secretKey, dic)
	return postURL(targetURL, dic)
}

func (p *PushManager) PushToSingle(device_type, channel_id, msg_type, msg, deploy_status string, parameters map[string]interface{}) (resp map[string]interface{}, err error) {
...
func (p *PushManager) PushToTag(device_type, tag, msg_type, msg, deploy_status string, parameters map[string]interface{}) (resp map[string]interface{}, err error) {
...
func (p *PushManager) PushToBatchDevices(device_type, msg_type, msg, topicId string, channel_ids []string, parameters map[string]interface{}) (resp map[string]interface{}, err error) {
